...
class ClipInsetShadowPath extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DecoratedBox(
      ...
      child: CustomPaint(
        painter: _ClipInsetShadowShadowPainter(
          clipper: this.clipper,
          shadows: this.shadows,
        ),
        child: child,
...
class _ClipInsetShadowShadowPainter extends CustomPainter {
  final List<ShapeShadow>? shadows;
  final CustomClipper<Path> clipper;

  _ClipInsetShadowShadowPainter({
...
class ShapedContainer extends StatelessWidget {
  ...
  ShapedContainer({this.shape, this.shadows, this.decoration, this.child});
