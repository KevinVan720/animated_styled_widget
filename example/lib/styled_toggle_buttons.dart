...
class StyledToggleButtonsPage extends StatefulWidget {
  StyledToggleButtonsPage({this.title = "Styled Buttons"});
  ...
  void initState() {
    ...
    neumorphicStyle = Style(
        ...
        padding: DynamicEdgeInsets.symmetric(
            vertical: 20.toPXLength, horizontal: 20.toPXLength),
        margin: DynamicEdgeInsets.symmetric(horizontal: 10.toPXLength),
    ...
    neonStyle = Style(
        alignment: Alignment.center,
        margin: DynamicEdgeInsets.symmetric(horizontal: 5.toPXLength),
